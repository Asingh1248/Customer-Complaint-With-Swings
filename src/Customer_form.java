...
public class Customer_form extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Customer_Address");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            String sql="Insert into Customer_Master(Customer_Name,Customer_Address) values (?,?);";
            PreparedStatement ps=con.prepareStatement(sql);
            //Four Statement to Remember About
            ...
            //*******************
            ps.executeUpdate();
            /* Imp*/JOptionPane.showMessageDialog(this,"Complaint Registered Successfully");
            System.out.println("Inserted Succesfully");
            this.setVisible(false);
            
            //**************************
            Statement stmt=con.createStatement();
            String sql1="select * from Customer_Master where Customer_name='"+Name+"' AND Customer_Address= '"+Address+"' ";
            ResultSet rs=stmt.executeQuery(sql1);
            
            if(rs.next())
            {
                userdata.cid=rs.getString(1);
                userdata.cname=rs.getString(3);
                
            }
             System.out.println(userdata.cid);
             System.out.println(userdata.cname);
